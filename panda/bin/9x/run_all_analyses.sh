...
if [ $NSEL == 0 ]; then
  ...
  nohup time root -q -l -b MitAnalysisRunII/panda/macros/9x/sswwAnalysis.C+'('${YEAR}',4,1)' >& log_ssww_fid4_${YEAR} &
  nohup time root -q -l -b MitAnalysisRunII/panda/macros/9x/sswwAnalysis.C+'('${YEAR}',5,1)' >& log_ssww_fid5_${YEAR} &
  fi
