...
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHSR_mvaTree_ZptBin0.root", "ZH_ZptBin0_2018", true,false,false,false)' >& train_ZptBin0_2018.txt &
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHSR_mvaTree_ZptBin1.root", "ZH_ZptBin1_2018", true,false,false,false)' >& train_ZptBin1_2018.txt &
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHSR_mvaTree_ZptBin2.root", "ZH_ZptBin2_2018", true,false,false,false)' >& train_ZptBin2_2018.txt &
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHFJSR.root",               "ZH_boosted_2018", true,true ,false,false)' >& train_boosted_2018.txt &
...
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHSR_mvaTree_ZptBin0.root", "VZ_ZptBin0_2018", false,false,false,false)' >& train_VZ_ZptBin0_2018.txt &
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHSR_mvaTree_ZptBin1.root", "VZ_ZptBin1_2018", false,false,false,false)' >& train_VZ_ZptBin1_2018.txt &
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHSR_mvaTree_ZptBin2.root", "VZ_ZptBin2_2018", false,false,false,false)' >& train_VZ_ZptBin2_2018.txt &
nohup root -b -l -q MitVHBBAnalysis/macros/zhbbMVA.C+'("MitVHBBAnalysis/mva_frozen/test2018/ZllHFJSR.root",               "VZ_boosted_2018", false,true ,false,false)' >& train_VZ_boosted_2018.txt &
