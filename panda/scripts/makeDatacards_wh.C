...
datacardsFromHistograms("whbb/testcondor2016", kWHHeavyFlavorLoMassCR, true, 3, 2016, applyBtagPtEta);
datacardsFromHistograms("whbb/testcondor2016", kWHHeavyFlavorHiMassCR, true, 3, 2016, applyBtagPtEta);
...
datacardsFromHistograms("whbb/testcondor2017", kWHHeavyFlavorLoMassCR, true, 3, 2017, applyBtagPtEta);
datacardsFromHistograms("whbb/testcondor2017", kWHHeavyFlavorHiMassCR, true, 3, 2017, applyBtagPtEta);
