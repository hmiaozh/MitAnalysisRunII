...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHSR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZmmHSR_ZptBin1.root", "Z(#mu#mu)H SR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHSR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZeeHSR_ZptBin1.root", "Z(ee)H SR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHSR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZemHSR_ZptBin1.root", "Z(e#mu)H SR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHLightFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZmmHLightFlavorCR_ZptBin1.root", "Z(#mu#mu)H Light Flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHLightFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZeeHLightFlavorCR_ZptBin1.root", "Z(ee)H Light Flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHHeavyFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZmmHHeavyFlavorCR_ZptBin1.root", "Z(#mu#mu)H Heavy flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHHeavyFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZeeHHeavyFlavorCR_ZptBin1.root", "Z(ee)H Heavy flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllH2TopCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZmmH2TopCR_ZptBin1.root", "Z(#mu#mu)H Top CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllH2TopCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZeeH2TopCR_ZptBin1.root", "Z(ee)H Top CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITZH2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHVZbbCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZmmHVZbbCR_ZptBin1.root", "Z(#mu#mu)H VZ CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITVZ2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHVZbbCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZemHVZbbCR_ZptBin1.root", "Z(e#mu)H VZ CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITVZ2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHVZbbCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2016/plots_ZeeHVZbbCR_ZptBin1.root", "Z(ee)H VZ CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2016","'${MLFITVZ2016}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHSR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZmmHSR_ZptBin1.root", "Z(#mu#mu)H SR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHSR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZeeHSR_ZptBin1.root", "Z(ee)H SR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHSR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZemHSR_ZptBin1.root", "Z(e#mu)H SR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHLightFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZmmHLightFlavorCR_ZptBin1.root", "Z(#mu#mu)H Light Flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHLightFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZeeHLightFlavorCR_ZptBin1.root", "Z(ee)H Light Flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHHeavyFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZmmHHeavyFlavorCR_ZptBin1.root", "Z(#mu#mu)H Heavy flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHHeavyFlavorCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZeeHHeavyFlavorCR_ZptBin1.root", "Z(ee)H Heavy flavor CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllH2TopCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZmmH2TopCR_ZptBin1.root", "Z(#mu#mu)H Top CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllH2TopCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZeeH2TopCR_ZptBin1.root", "Z(ee)H Top CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITZH2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHVZbbCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZmmHVZbbCR_ZptBin1.root", "Z(#mu#mu)H VZ CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITVZ2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHVZbbCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZemHVZbbCR_ZptBin1.root", "Z(e#mu)H VZ CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITVZ2017}'")'
...
root -q -b -l MitVHBBAnalysis/macros/finalPlot2018.C+'(kZllHVZbbCR,  "MitVHBBAnalysis/datacards/zhbb/testcondor2017/plots_ZeeHVZbbCR_ZptBin1.root", "Z(ee)H VZ CR selection, high p_{T} resolved", "", false, false, "MitVHBBAnalysis/plots2017","'${MLFITVZ2017}'")'
...
root -q -b -l scripts/signalToBackground.C+'("'${MLFITZH2016}'","stob_ZH2016",false)';
root -q -b -l scripts/signalToBackground.C+'("'${MLFITZH2017}'","stob_ZH2017",false)';
hadd -f stob_ZHcomb.root stob_ZH2016.root stob_ZH2017.root;
root -q -b -l scripts/signalToBackground.C+'("","stob_ZHcomb",false,true,true)'; # mlfitResult/outputFileName/isZHSignal/doRatioPad/isBlinded
mv plot_stob_ZHcomb.pdf plot_stob_ZHcomb_exp.pdf;
root -q -b -l scripts/signalToBackground.C+'("","stob_ZHcomb",false,true,false)';
mv plot_stob_ZHcomb.pdf plot_stob_ZHcomb_obs.pdf;

root -q -b -l scripts/signalToBackground.C+'("'${MLFITVZ2016}'","stob_VZ2016",true)';
root -q -b -l scripts/signalToBackground.C+'("'${MLFITVZ2017}'","stob_VZ2017",true)';
hadd -f stob_VZcomb.root stob_VZ2016.root stob_VZ2017.root;
root -q -b -l scripts/signalToBackground.C+'("","stob_VZcomb",false,true,true)';
mv plot_stob_VZcomb.pdf plot_stob_VZcomb_exp.pdf;
root -q -b -l scripts/signalToBackground.C+'("","stob_VZcomb",false,true,false)';
