...
if [ $NSEL == 'wz' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_118.root","ssww_wwselp_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_119.root","ssww_wwseln_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_120.root","ssww_wwselpn_mjj",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_121.root","ssww_wwselp_mll",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_122.root","ssww_wwseln_mll",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_123.root","ssww_wwselpn_mll",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
