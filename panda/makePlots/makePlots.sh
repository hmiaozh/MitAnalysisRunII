...
if [ $NSEL == 'wz' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{ll}","GeV","done_dy/histoDY0MGStudy_'${YEAR}'_0.root","zmg_mmg",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{T}^{#mu#gamma}","GeV","done_dy/histoDY0MGStudy_'${YEAR}'_1.root","zmg_mt",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_0.root","zlg_mee",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_2.root","zlg_ptee",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_3.root","zlg_ptee_0",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_4.root","zlg_ptee_1",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_5.root","zlg_ptee_2",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_6.root","zlg_ptee_3",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_7.root","zlg_ptee_4",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_1.root","zlg_meg",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_8.root","zlg_pteg",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_9.root","zlg_pteg_0",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_10.root","zlg_pteg_1",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_11.root","zlg_pteg_2",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_12.root","zlg_pteg_3",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","GeV","done_dy/histoDY0EGStudy_'${YEAR}'_13.root","zlg_pteg_4",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_0.root","zlg_meg_0",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_1.root","zlg_meg_1",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_2.root","zlg_meg_2",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_3.root","zlg_meg_3",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_4.root","zlg_meg_4",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_5.root","zlg_meg_5",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_6.root","zlg_meg_6",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_7.root","zlg_meg_7",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_8.root","zlg_meg_8",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_9.root","zlg_meg_9",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_10.root","zlg_meg_10",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_11.root","zlg_meg_11",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_12.root","zlg_meg_12",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_13.root","zlg_meg_13",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_14.root","zlg_meg_14",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_15.root","zlg_meg_15",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_16.root","zlg_meg_16",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_17.root","zlg_meg_17",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_18.root","zlg_meg_18",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_19.root","zlg_meg_19",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_20.root","zlg_meg_20",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_21.root","zlg_meg_21",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_22.root","zlg_meg_22",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_23.root","zlg_meg_23",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_24.root","zlg_meg_24",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_25.root","zlg_meg_25",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_26.root","zlg_meg_26",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_27.root","zlg_meg_27",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_28.root","zlg_meg_28",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_29.root","zlg_meg_29",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_30.root","zlg_meg_30",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_31.root","zlg_meg_31",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_32.root","zlg_meg_32",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_33.root","zlg_meg_33",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_34.root","zlg_meg_34",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_35.root","zlg_meg_35",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_36.root","zlg_meg_36",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_37.root","zlg_meg_37",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_38.root","zlg_meg_38",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_49.root","zlg_meg_49",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_40.root","zlg_meg_40",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_41.root","zlg_meg_41",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_42.root","zlg_meg_42",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_43.root","zlg_meg_43",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_44.root","zlg_meg_44",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_45.root","zlg_meg_45",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_46.root","zlg_meg_46",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_47.root","zlg_meg_47",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_48.root","zlg_meg_48",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{l#gamma}","GeV","done_dy/histoDY0EGStudyMLG_'${YEAR}'_49.root","zlg_meg_49",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_18.root","wwmm_0j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_19.root","wwee_0j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_20.root","wwem_0j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_21.root","wwmm_1j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_22.root","wwee_1j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_23.root","wwem_1j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_24.root","wwmm_2j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_25.root","wwee_2j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"E_{T}^{miss}","GeV","done_ana/histoWW_'${YEAR}'_26.root","wwem_2j_allbutminpmet_met",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{WW}","GeV","done_ana/histoWW_'${YEAR}'_165.root","wwee_topsel_ptww",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{WW}","GeV","done_ana/histoWW_'${YEAR}'_167.root","wwee_topsel_ptww",0,'${YEAR}',"H(125)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
