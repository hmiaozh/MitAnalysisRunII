...
if [ $NSEL == 'wz' ]; then
  ...
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINNoBSM","done_ana/histoZHG_mH125_'${YEAR}'_2.root","zhg_emusel_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(#gamma_{D}+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"e#mu region",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125_obs.root","ZHG_2019_125",0,"","",1)';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINNoBSM","done_ana/histoZHG_mH125_'${YEAR}'_09101112.root","zhg_wzsel_mtg_withratio",1,'${YEAR}',"Z(ll)H_{125}(#gamma_{D}+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ region",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125_obs.root","ZHG_2019_125",0,"","")';
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINNoBSM","done_ana/histoZHG_mH125_'${YEAR}'_171819.root","zhg_zzsel_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(#gamma_{D}+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"ZZ region",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125_obs.root","ZHG_2019_125",0,"","")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINNoBSM","done_ana/histoZHG_mH125_'${YEAR}'_2.root","zhg_emusel_mtg",0,'${YEAR}',"Z(ll)H_{125}(#gamma_{D}+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"e#mu region",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125_obs.root","ZHG_2019_125",0,"","",1)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINNoBSM","done_ana/histoZHG_mH125_'${YEAR}'_09101112.root","zhg_wzsel_mtg",1,'${YEAR}',"Z(ll)H_{125}(#gamma_{D}+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ region",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125_obs.root","ZHG_2019_125",0,"","")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINNoBSM","done_ana/histoZHG_mH125_'${YEAR}'_171819.root","zhg_zzsel_mtg",0,'${YEAR}',"Z(ll)H_{125}(#gamma_{D}+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"ZZ region",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125_obs.root","ZHG_2019_125",0,"","")';
