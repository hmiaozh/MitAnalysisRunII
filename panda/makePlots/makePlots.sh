...
if [ $NSEL == 'wz' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeV","done_ana/histoWZ_'${YEAR}'_69.root","wz_zxlikeloose_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","WZ_'${YEAR}'",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","ZZ_'${YEAR}'",0)';
  export YEAR=2017;
  export mlfitResult="comb/../ana_zh/fitDiagnosticszh_comb_obs.root";
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","WZ_'${YEAR}'",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","ZZ_'${YEAR}'",0)';
  ...
  for NJET in 0 1; do
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0001.root","zh_zhtightsel_mt_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_48.root","zhll_zhsel_dphidilepmettight_nj0_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_49.root","zhll_zhsel_dphidilepmetloose_nj0_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_50.root","zhll_zhsel_dphidilepmettight_nj1_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_51.root","zhll_zhsel_dphidilepmetloose_nj1_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_52.root","zhem_zhsel_dphidilepmettight_njle1_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"#leq 1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_53.root","zhem_zhsel_dphidilepmetloose_njle1_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"#leq 1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_45.root","zhmm_cutevol_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_46.root","zhee_cutevol_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_47.root","zhem_cutevol_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_54.root","zhmm_presel_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_55.root","zhee_presel_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_56.root","zhem_presel_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_57.root","zhmm_presel_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_58.root","zhee_presel_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_59.root","zhem_presel_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_60.root","zhmm_presel_ptfrac_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_61.root","zhee_presel_ptfrac_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_62.root","zhem_presel_ptfrac_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_66.root","zhmm_presel_nbjets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_67.root","zhee_presel_nbjets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_68.root","zhem_presel_nbjets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"No jet selection #eta_{j}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_69.root","zh_nojetsel_etaj_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_70.root","zh_nojetsel_njets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"No jet selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_71.root","zh_nojetsel_dphidilepmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_72.root","zh_nojetsel_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH selection #phi","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_73.root","zh_zhsel_phi_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{llj}/ H_{T}^{llj}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_74.root","zh_zhsel_vtptht_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"p_{T}^{max}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_79.root","zh_zhsel_ptl1_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"p_{T}^{min}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_80.root","zh_zhsel_ptl2_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}')';
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0.root","zhmm_zhtightsel_mt_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_3.root","zhmm_zhsel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_6.root","zhmm_btagsel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_9.root","zhmm_presel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_12.root","zhmm_ww_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_15.root","zhmm_zhselnminus1_mz_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_18.root","zhmm_zhselnminus1_njets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_21.root","zhmm_zhselnminus1_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_24.root","zhmm_zhselnminus1_ptfrac_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_30.root","zhmm_zhselnminus1_nbjets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_33.root","zhmm_zhselnminus1_ptll_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_36.root","zhmm_zhselnminus1_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_39.root","zhmm_zhselnminus1_ntau_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_42.root","zhmm_zhselnminus1_drll_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_1.root","zhee_zhtightsel_mt_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_4.root","zhee_zhsel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_7.root","zhee_btagsel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_10.root","zhee_presel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_13.root","zhee_ww_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_16.root","zhee_zhselnminus1_mz_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_19.root","zhee_zhselnminus1_njets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_22.root","zhee_zhselnminus1_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_25.root","zhee_zhselnminus1_ptfrac_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_28.root","zhee_zhselnminus1_dphidilepmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_31.root","zhee_zhselnminus1_nbjets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_34.root","zhee_zhselnminus1_ptll_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_37.root","zhee_zhselnminus1_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_40.root","zhee_zhselnminus1_ntau_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_43.root","zhee_zhselnminus1_drll_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_2.root","zhem_zhtightsel_mt_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_5.root","zhem_zhsel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_8.root","zhem_btagsel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_11.root","zhem_presel_met_'${NJET}'j",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_14.root","zhem_ww_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_17.root","zhem_zhselnminus1_mz_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_20.root","zhem_zhselnminus1_njets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_23.root","zhem_zhselnminus1_met_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_26.root","zhem_zhselnminus1_ptfrac_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_32.root","zhem_zhselnminus1_nbjets_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_35.root","zhem_zhselnminus1_ptll_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_38.root","zhem_zhselnminus1_dphijetmet_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_41.root","zhem_zhselnminus1_ntau_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_44.root","zhem_zhselnminus1_drll_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  done
