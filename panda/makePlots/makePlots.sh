...
if [ $NSEL == 'wz' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_5455.root","zh_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_54.root","zhmm_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_55.root","zhee_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_56.root","zhem_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
