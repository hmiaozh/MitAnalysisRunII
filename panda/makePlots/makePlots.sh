...
if [ $NSEL == 'wz' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","WZ_'${YEAR}'",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","ZZ_'${YEAR}'",0)';
  export YEAR=2017;
  export mlfitResult="comb/../ana_zh/fitDiagnosticszh_comb_obs.root";
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","WZ_'${YEAR}'",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","ZZ_'${YEAR}'",0)';
  ...
  for NJET in 0 1; do
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0001.root","zh_zhtightsel_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0304.root","zh_zhsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0607.root","zh_btagsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0910.root","zh_presel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_1213.root","zh_ww_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_1516.root","zh_zhselnminus1_mz",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_1819.root","zh_zhselnminus1_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_2122.root","zh_zhselnminus1_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_2425.root","zh_zhselnminus1_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_2728.root","zh_zhselnminus1_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_3031.root","zh_zhselnminus1_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_3334.root","zh_zhselnminus1_ptll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_3637.root","zh_zhselnminus1_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_3940.root","zh_zhselnminus1_ntau",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_4243.root","zh_zhselnminus1_drll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_4546.root","zh_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_5455.root","zh_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_5758.root","zh_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_6061.root","zh_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_6364.root","zh_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_6667.root","zh_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_48.root","zhll_zhsel_dphidilepmettight_nj0_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_49.root","zhll_zhsel_dphidilepmetloose_nj0_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_50.root","zhll_zhsel_dphidilepmettight_nj1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_51.root","zhll_zhsel_dphidilepmetloose_nj1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_52.root","zhem_zhsel_dphidilepmettight_njle1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"#leq 1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_53.root","zhem_zhsel_dphidilepmetloose_njle1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"#leq 1 jet category",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_45.root","zhmm_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_46.root","zhee_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_47.root","zhem_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_54.root","zhmm_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_55.root","zhee_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_56.root","zhem_presel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_57.root","zhmm_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_58.root","zhee_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_59.root","zhem_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_60.root","zhmm_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_61.root","zhee_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_62.root","zhem_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_63.root","zhmm_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_64.root","zhee_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_65.root","zhem_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_66.root","zhmm_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_67.root","zhee_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_68.root","zhem_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"No jet selection #eta_{j}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_69.root","zh_nojetsel_etaj",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_70.root","zh_nojetsel_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"No jet selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_71.root","zh_nojetsel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_72.root","zh_nojetsel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH selection #phi","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_73.root","zh_zhsel_phi",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{llj}/ H_{T}^{llj}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_74.root","zh_zhsel_vtptht",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"p_{T}^{max}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_79.root","zh_zhsel_ptl1",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"p_{T}^{min}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_80.root","zh_zhsel_ptl2",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}')';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"e#mu + p_{T}^{miss}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_81.root","zh_card_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_0.root","zhmm_zhtightsel_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_3.root","zhmm_zhsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_6.root","zhmm_btagsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_9.root","zhmm_presel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_12.root","zhmm_ww_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_15.root","zhmm_zhselnminus1_mz",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_18.root","zhmm_zhselnminus1_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_21.root","zhmm_zhselnminus1_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_24.root","zhmm_zhselnminus1_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_27.root","zhmm_zhselnminus1_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_30.root","zhmm_zhselnminus1_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_33.root","zhmm_zhselnminus1_ptll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_36.root","zhmm_zhselnminus1_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_39.root","zhmm_zhselnminus1_ntau",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_42.root","zhmm_zhselnminus1_drll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_1.root","zhee_zhtightsel_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_4.root","zhee_zhsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_7.root","zhee_btagsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_10.root","zhee_presel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_13.root","zhee_ww_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_16.root","zhee_zhselnminus1_mz",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_19.root","zhee_zhselnminus1_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_22.root","zhee_zhselnminus1_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_25.root","zhee_zhselnminus1_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_28.root","zhee_zhselnminus1_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_31.root","zhee_zhselnminus1_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_34.root","zhee_zhselnminus1_ptll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_37.root","zhee_zhselnminus1_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_40.root","zhee_zhselnminus1_ntau",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_43.root","zhee_zhselnminus1_drll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_2.root","zhem_zhtightsel_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_5.root","zhem_zhsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B-tagged selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_8.root","zhem_btagsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_11.root","zhem_presel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"WW-like selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_14.root","zhem_ww_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_17.root","zhem_zhselnminus1_mz",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_20.root","zhem_zhselnminus1_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_23.root","zhem_zhselnminus1_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_26.root","zhem_zhselnminus1_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_29.root","zhem_zhselnminus1_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_32.root","zhem_zhselnminus1_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_'${NJET}'j_35.root","zhem_zhselnminus1_ptll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_38.root","zhem_zhselnminus1_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_41.root","zhem_zhselnminus1_ntau",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_44.root","zhem_zhselnminus1_drll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  done
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_100.root","ssww_mm_presel_detajj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_103.root","ssww_mm_presel_zstar",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_106.root","ssww_mm_presel_ptj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_109.root","ssww_mm_presel_etaj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_112.root","ssww_mm_presel_ptl",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_115.root","ssww_mm_presel_etal",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_98.root","ssww_ee_presel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_101.root","ssww_ee_presel_detajj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_104.root","ssww_ee_presel_zstar",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_107.root","ssww_ee_presel_ptj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_110.root","ssww_ee_presel_etaj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_113.root","ssww_ee_presel_ptl",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_116.root","ssww_ee_presel_etal",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_99.root","ssww_em_presel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_102.root","ssww_em_presel_detajj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_105.root","ssww_em_presel_zstar",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_108.root","ssww_em_presel_ptj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_111.root","ssww_em_presel_etaj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_114.root","ssww_em_presel_ptl",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_117.root","ssww_em_presel_etal",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_118.root","ssww_wwselp_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_119.root","ssww_wwseln_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_120.root","ssww_wwselpn_mjj",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_121.root","ssww_wwselp_mll",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_122.root","ssww_wwseln_mll",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_123.root","ssww_wwselpn_mll",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_0.root","ssww_wwsel_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_1.root","ssww_btagsel_mjj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_2.root","ssww_zzsel_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_3.root","ssww_wzbsel_mjj",0, '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_4.root","ssww_wzsel_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_5.root","ssww_wwsel_detajj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_6.root","ssww_btagsel_detajj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_7.root","ssww_zzsel_detajj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_8.root","ssww_wzbsel_detajj",0, '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_9.root","ssww_wzsel_detajj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Lepton type","","done_ana/histossww_'${YEAR}'_10.root","ssww_wwsel_leptype",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Lepton type","","done_ana/histossww_'${YEAR}'_11.root","ssww_btagsel_leptype",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Lepton type","","done_ana/histossww_'${YEAR}'_12.root","ssww_zzsel_leptype",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Lepton type","","done_ana/histossww_'${YEAR}'_13.root","ssww_wzbsel_leptype",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Lepton type","","done_ana/histossww_'${YEAR}'_14.root","ssww_wzsel_leptype",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_15.root","ssww_wwsel_ptj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_16.root","ssww_btagsel_ptj",0,'${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_17.root","ssww_zzsel_ptj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_18.root","ssww_wzbsel_ptj",0, '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_19.root","ssww_wzsel_ptj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#eta^{j}","","done_ana/histossww_'${YEAR}'_20.root","ssww_wwsel_etaj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#eta^{j}","","done_ana/histossww_'${YEAR}'_21.root","ssww_btagsel_etaj",0,'${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#eta^{j}","","done_ana/histossww_'${YEAR}'_22.root","ssww_zzsel_etaj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#eta^{j}","","done_ana/histossww_'${YEAR}'_23.root","ssww_wzbsel_etaj",0, '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#eta^{j}","","done_ana/histossww_'${YEAR}'_24.root","ssww_wzsel_etaj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_25.root","ssww_wwsel_njet",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_26.root","ssww_btagsel_njet",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_27.root","ssww_zzsel_njet",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_28.root","ssww_wzbsel_njet",0, '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_29.root","ssww_wzsel_njet",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  hadd -f done_ana/histossww_'${YEAR}'_333435.root done_ana/histossww_'${YEAR}'_33.root  done_ana/histossww_'${YEAR}'_34.root   done_ana/histossww_'${YEAR}'_35.root
  hadd -f done_ana/histossww_'${YEAR}'_363738.root done_ana/histossww_'${YEAR}'_36.root  done_ana/histossww_'${YEAR}'_37.root   done_ana/histossww_'${YEAR}'_38.root
  hadd -f done_ana/histossww_'${YEAR}'_394041.root done_ana/histossww_'${YEAR}'_39.root  done_ana/histossww_'${YEAR}'_40.root   done_ana/histossww_'${YEAR}'_41.root
  hadd -f done_ana/histossww_'${YEAR}'_424344.root done_ana/histossww_'${YEAR}'_42.root  done_ana/histossww_'${YEAR}'_43.root   done_ana/histossww_'${YEAR}'_44.root
  hadd -f done_ana/histossww_'${YEAR}'_454647.root done_ana/histossww_'${YEAR}'_45.root  done_ana/histossww_'${YEAR}'_46.root   done_ana/histossww_'${YEAR}'_47.root
  hadd -f done_ana/histossww_'${YEAR}'_484950.root done_ana/histossww_'${YEAR}'_48.root  done_ana/histossww_'${YEAR}'_49.root   done_ana/histossww_'${YEAR}'_50.root
  hadd -f done_ana/histossww_'${YEAR}'_515253.root done_ana/histossww_'${YEAR}'_51.root  done_ana/histossww_'${YEAR}'_52.root   done_ana/histossww_'${YEAR}'_53.root
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{ll}","GeV","done_ana/histossww_'${YEAR}'_303132.root","ssww_wwselnminus1_mll",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{miss}","GeV","done_ana/histossww_'${YEAR}'_333435.root","ssww_wwselnminus1_met",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jets}","","done_ana/histossww_'${YEAR}'_363738.root","ssww_wwselnminus1_njets",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|#Delta#eta_{jj}|","","done_ana/histossww_'${YEAR}'_394041.root","ssww_wwselnminus1_detajj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_424344.root","ssww_wwselnminus1_mjj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_454647.root","ssww_wwselnminus1_zstar",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histossww_'${YEAR}'_484950.root","ssww_wwselnminus1_nbjets",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{#tau}","","done_ana/histossww_'${YEAR}'_515253.root","ssww_wwselnminus1_ntau",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_54.root","ssww_presel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_55.root","ssww_presel_detajj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_56.root","ssww_presel_zstar",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{loose b jets}","","done_ana/histossww_'${YEAR}'_57.root","ssww_presel_nlbjets",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{medium b jets}","","done_ana/histossww_'${YEAR}'_58.root","ssww_presel_nmbjets",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{medium b jets}","","done_ana/histossww_'${YEAR}'_59.root","ssww_presel_nlbjetsgt0_nmbjets",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_60.root","ssww_presel_ptj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_61.root","ssww_presel_etaj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_62.root","ssww_presel_ptl",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_63.root","ssww_presel_etal",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B tag max","","done_ana/histossww_'${YEAR}'_64.root","ssww_presel_btagmax",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"B tag min","","done_ana/histossww_'${YEAR}'_65.root","ssww_presel_btagmin",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GevBIN","done_ana/histossww_'${YEAR}'_66.root","ssww_wwsel_mll",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GevBIN","done_ana/histossww_'${YEAR}'_67.root","ssww_btagsel_mll",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{leading}","GeV","done_ana/histossww_'${YEAR}'_686970.root","ssww_wwsel_ptl1",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{trailing}","GeV","done_ana/histossww_'${YEAR}'_717273.root","ssww_wwsel_ptl2",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeV","done_ana/histossww_'${YEAR}'_78.root","ssww_wzsel_mtwz",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_79.root","ssww_qcdwwsel_mjj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_80.root","ssww_qcdbtagsel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_81.root","ssww_qcdzzsel_mjj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_82.root","ssww_qcdwzbsel_mjj" ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_83.root","ssww_qcdwzsel_mjj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_84.root","ssww_qcdwwsel_detajj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_85.root","ssww_qcdbtagsel_detajj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_86.root","ssww_qcdzzsel_detajj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_87.root","ssww_qcdwzbsel_detajj" ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_88.root","ssww_qcdwzsel_detajj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","BIN","done_ana/histossww_'${YEAR}'_89.root","ssww_wwsel_bdt",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","BIN","done_ana/histossww_'${YEAR}'_90.root","ssww_btagsel_bdt",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","BIN","done_ana/histossww_'${YEAR}'_91.root","ssww_wzbsel_bdt",0,'${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#phi_{jj}","","done_ana/histossww_'${YEAR}'_92.root","ssww_wzsel_dphijj",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{l^{W}-Z}","","done_ana/histossww_'${YEAR}'_93.root","ssww_wzsel_detawlz",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"WZ z^{*}","","done_ana/histossww_'${YEAR}'_94.root","ssww_wzsel_wzzep",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta R_{j1Z}","","done_ana/histossww_'${YEAR}'_95.root","ssww_wzsel_drj1z",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"Sum p^{vectorial}_{T} / p^{scalar}_{T}","","done_ana/histossww_'${YEAR}'_96.root","ssww_wzsel_ptotrel",0,  '${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
