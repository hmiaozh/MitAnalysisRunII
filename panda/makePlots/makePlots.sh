...
if [ $NSEL == 'wz' ]; then
  ...
  export YEAR=2016;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"done_ana/fitDiagnosticszh_comb_obs.root","ch1_ch2",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"done_ana/fitDiagnosticszh_comb_obs.root","ch1_ch3",0)';
  export YEAR=2017;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"done_ana/fitDiagnosticszh_comb_obs.root","ch2_ch2",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"done_ana/fitDiagnosticszh_comb_obs.root","ch2_ch3",0)';
  export YEAR=2018;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"done_ana/fitDiagnosticszh_comb_obs.root","ch3_ch2",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"done_ana/fitDiagnosticszh_comb_obs.root","ch3_ch3",0)';
  export YEAR=2019;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoWZ_'${YEAR}'_81.root","wz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ch1_ch2",0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBIN","done_ana/histoZZ_'${YEAR}'_70.root","zz_card_met",0,'${YEAR}',"",1,0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ch1_ch3",0)';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_0001.root","zh_zhtightsel_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_0304.root","zh_zhsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZH_'${YEAR}'_1516.root","zh_zhselnminus1_mz",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZH_'${YEAR}'_1819.root","zh_zhselnminus1_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_2122.root","zh_zhselnminus1_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_2425.root","zh_zhselnminus1_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZH_'${YEAR}'_3031.root","zh_zhselnminus1_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZH_'${YEAR}'_3334.root","zh_zhselnminus1_ptll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_3637.root","zh_zhselnminus1_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZH_'${YEAR}'_3940.root","zh_zhselnminus1_ntau",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"N-1 ZH selection #Delta R_{ll}","","done_ana/histoZH_'${YEAR}'_4243.root","zh_zhselnminus1_drll",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_48.root","zhll_zhsel_dphidilepmettight_nj0_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_49.root","zhll_zhsel_dphidilepmetloose_nj0_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_50.root","zhll_zhsel_dphidilepmettight_nj1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_51.root","zhll_zhsel_dphidilepmetloose_nj1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_52.root","zhem_zhsel_dphidilepmettight_njle1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"#leq 1 jet category",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_53.root","zhem_zhsel_dphidilepmetloose_njle1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"#leq 1 jet category",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss} X 4 regions","","done_ana/histoZH_'${YEAR}'_81.root","zh_card_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"comb/fitDiagnosticszh_comb_obs.root","ZH_2019")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GevBINBinWidth","done_ana/histossww_'${YEAR}'_1.root","ssww_btagsel_mjj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GevBINBinWidth","done_ana/histossww_'${YEAR}'_2.root","ssww_zzsel_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GevBINBinWidth","done_ana/histossww_'${YEAR}'_3.root","ssww_wzbsel_mjj",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GevBINBinWidth","done_ana/histossww_'${YEAR}'_4.root","ssww_wzsel_mjj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_7.root","ssww_zzsel_detajj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_8.root","ssww_wzbsel_detajj",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_9.root","ssww_wzsel_detajj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_16.root","ssww_btagsel_ptj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_17.root","ssww_zzsel_ptj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_18.root","ssww_wzbsel_ptj",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_19.root","ssww_wzsel_ptj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#eta^{j}","","done_ana/histossww_'${YEAR}'_20.root","ssww_wwsel_etaj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#eta^{j}","","done_ana/histossww_'${YEAR}'_21.root","ssww_btagsel_etaj",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#eta^{j}","","done_ana/histossww_'${YEAR}'_22.root","ssww_zzsel_etaj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#eta^{j}","","done_ana/histossww_'${YEAR}'_23.root","ssww_wzbsel_etaj",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#eta^{j}","","done_ana/histossww_'${YEAR}'_24.root","ssww_wzsel_etaj",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_27.root","ssww_zzsel_njet",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_28.root","ssww_wzbsel_njet",0, '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{jet}","","done_ana/histossww_'${YEAR}'_29.root","ssww_wzsel_njet",0,  '${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_79.root","ssww_qcdwwsel_mjj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_80.root","ssww_qcdbtagsel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_81.root","ssww_qcdzzsel_mjj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_82.root","ssww_qcdwzbsel_mjj" ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_83.root","ssww_qcdwzsel_mjj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_84.root","ssww_qcdwwsel_detajj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_85.root","ssww_qcdbtagsel_detajj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_86.root","ssww_qcdzzsel_detajj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_87.root","ssww_qcdwzbsel_detajj" ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_88.root","ssww_qcdwzsel_detajj"  ,0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Output fit","BIN","done_ana/histossww_'${YEAR}'_91.root","ssww_datacard",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
