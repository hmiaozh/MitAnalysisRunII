...
if [ $NSEL == 'wz' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH tight selection m_{T}","GeV","done_ana/histoZH_'${YEAR}'_0001.root","zh_zhtightsel_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH selection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_0304.root","zh_zhsel_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"#Delta#phi_{track p_{T}^{miss},p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_5455.root","zh_dphimettrkmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_5758.root","zh_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_6061.root","zh_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_6364.root","zh_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection N_{b jets}","","done_ana/histoZH_'${YEAR}'_6667.root","zh_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"No jet selection #eta_{j}","","done_ana/histoZH_'${YEAR}'_6970.root","zh_nojetsel_etaj",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{jets}","","done_ana/histoZH_'${YEAR}'_7273.root","zh_nojetsel_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{central jets}","","done_ana/histoZH_'${YEAR}'_7576.root","zh_nojetsel_ncjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"No jet selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_7879.root","zh_nojetsel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_8182.root","zh_nojetsel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_48.root","zhll_zhsel_dphidilepmettight_nj0_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_49.root","zhll_zhsel_dphidilepmetloose_nj0_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_50.root","zhll_zhsel_dphidilepmettight_nj1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_51.root","zhll_zhsel_dphidilepmetloose_nj1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_52.root","zhem_zhsel_dphidilepmettight_njle1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_53.root","zhem_zhsel_dphidilepmetloose_njle1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"#Delta#phi_{track p_{T}^{miss},p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_54.root","zhmm_dphimettrkmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"#Delta#phi_{track p_{T}^{miss},p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_55.root","zhee_dphimettrkmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"#Delta#phi_{track p_{T}^{miss},p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_56.root","zhem_dphimettrkmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_57.root","zhmm_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_58.root","zhee_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection p_{T}^{miss}","GeV","done_ana/histoZH_'${YEAR}'_59.root","zhem_presel_met",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_60.root","zhmm_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_61.root","zhee_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection |p_{T}^{ll}-p_{T}^{miss}|/p_{T}^{ll}","","done_ana/histoZH_'${YEAR}'_62.root","zhem_presel_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_63.root","zhmm_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_64.root","zhee_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH preselection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_65.root","zhem_presel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection N_{b jets}","","done_ana/histoZH_'${YEAR}'_66.root","zhmm_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection N_{b jets}","","done_ana/histoZH_'${YEAR}'_67.root","zhee_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH preselection N_{b jets}","","done_ana/histoZH_'${YEAR}'_68.root","zhem_presel_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"No jet selection #eta_{j}","","done_ana/histoZH_'${YEAR}'_69.root","zhmm_nojetsel_etaj",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"No jet selection #eta_{j}","","done_ana/histoZH_'${YEAR}'_70.root","zhee_nojetsel_etaj",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"No jet selection #eta_{j}","","done_ana/histoZH_'${YEAR}'_71.root","zhem_nojetsel_etaj",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{jets}","","done_ana/histoZH_'${YEAR}'_72.root","zhmm_nojetsel_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{jets}","","done_ana/histoZH_'${YEAR}'_73.root","zhee_nojetsel_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{jets}","","done_ana/histoZH_'${YEAR}'_74.root","zhem_nojetsel_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{central jets}","","done_ana/histoZH_'${YEAR}'_75.root","zhmm_nojetsel_ncjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{central jets}","","done_ana/histoZH_'${YEAR}'_76.root","zhee_nojetsel_ncjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection N_{central jets}","","done_ana/histoZH_'${YEAR}'_77.root","zhem_nojetsel_ncjets",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"No jet selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_78.root","zhmm_nojetsel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"No jet selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_79.root","zhee_nojetsel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,4,"No jet selection #Delta#phi_{ll,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_80.root","zhem_nojetsel_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_81.root","zhmm_nojetsel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_82.root","zhee_nojetsel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"No jet selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZH_'${YEAR}'_83.root","zhem_nojetsel_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss} X 4 regions","","done_ana/histoZH_'${YEAR}'_87.root","zh_card_met",1,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_2.root","zhg_emusel_mtg_prefit",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"e#mu region",0,'${APPLYSCALING}',"","",0,"","",1)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_09101112.root","zhg_wzsel_mtg_prefit",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ region",0,'${APPLYSCALING}',"","",0,"","")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_171819.root","zhg_zzsel_mtg_prefit",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"ZZ region",0,'${APPLYSCALING}',"","",0,"","")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_2.root","zhg_emusel_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"e#mu region",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"","",1)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_09101112.root","zhg_wzsel_mtg_withratio",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ region",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"","")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_171819.root","zhg_zzsel_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"ZZ region",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"","")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_2.root","zhg_emusel_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"e#mu region",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"","",1)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_09101112.root","zhg_wzsel_mtg",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ region",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"","")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_171819.root","zhg_zzsel_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"ZZ region",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"","")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_53.root","zhg_sigsel125200_etaglt1_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| < 1",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH200_2019_54.root","Z(ll)H_{200}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_54.root","zhg_sigsel125200_etaggt1_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| > 1",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH200_2019_54.root","Z(ll)H_{200}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_53.root","zhg_sigsel125300_etaglt1_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| < 1",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH300_2019_54.root","Z(ll)H_{300}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_54.root","zhg_sigsel125300_etaggt1_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| > 1",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH300_2019_54.root","Z(ll)H_{300}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_53.root","zhg_sigsel125200_etaglt1_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| < 1",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH200_2019_54.root","Z(ll)H_{200}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_54.root","zhg_sigsel125200_etaggt1_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| > 1",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH200_2019_54.root","Z(ll)H_{200}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_53.root","zhg_sigsel125300_etaglt1_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| < 1",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH300_2019_54.root","Z(ll)H_{300}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_54.root","zhg_sigsel125300_etaggt1_mtg_withratio",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"|#eta^{#gamma}| > 1",1,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125",0,"done_ana/histoZHG_mH300_2019_54.root","Z(ll)H_{300}(inv.+#gamma) (0.1 #times #sigma_{SM})")';
elif [ $NSEL == 'zhg' ]; then
  export sf_dy=1.0;
  export isBlinded=0;
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_0001.root","zhg_zh125sel_mtg"   ,0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH200_'${YEAR}'_0001.root","zhg_zh200sel_mtg",0,'${YEAR}',"Z(ll)H_{200}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_200.root","ZHG_2019_200")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH300_'${YEAR}'_0001.root","zhg_zh300sel_mtg",0,'${YEAR}',"Z(ll)H_{300}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_300.root","ZHG_2019_300")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_0304.root","zhg_btagsel_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"B tagged region",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_0607.root","zhg_zllgsel_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"Z#gamma region",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_13141516.root","zhg_wzgsel_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ#gamma region",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_ana/histoZHG_mH125_'${YEAR}'_2122.root","zhg_wwsel_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WW region",0,1)';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"N-1 ZH selection |m_{ll}-m_{Z}|","GeV","done_ana/histoZHG_mH125_'${YEAR}'_24.root","zhg_zhselnminus1_mz",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{jets}","","done_ana/histoZHG_mH125_'${YEAR}'_25.root","zhg_zhselnminus1_njets",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"N-1 ZH selection p_{T}^{miss}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_26.root","zhg_zhselnminus1_met",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"N-1 ZH selection |p_{T}^{ll}-p_{T}^{p_{T}^{miss}+E_{T}^{gamma}}|/p_{T}^{ll}","","done_ana/histoZHG_mH125_'${YEAR}'_27.root","zhg_zhselnminus1_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"N-1 ZH selection #Delta#phi_{ll,p_{T}^{miss}+E_{T}^{gamma}}","","done_ana/histoZHG_mH125_'${YEAR}'_28.root","zhg_zhselnminus1_dphidilepmet",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{b jets}","","done_ana/histoZHG_mH125_'${YEAR}'_29.root","zhg_zhselnminus1_nbjets",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"N-1 ZH selection p_{T}^{ll}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_30.root","zhg_zhselnminus1_ptll",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection #Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZHG_mH125_'${YEAR}'_31.root","zhg_zhselnminus1_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection N_{#tau}","","done_ana/histoZHG_mH125_'${YEAR}'_32.root","zhg_zhselnminus1_ntau",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,20,"N-1 ZH selection m_{T}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_33.root","zhg_zhselnminus1_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N-1 ZH selection m_{ll#gamma}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_34.root","zhg_zhselnminus1_mllg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"|#eta^{#gamma}|","","done_ana/histoZHG_mH125_'${YEAR}'_35.root","zhg_zhsel_etag",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_2019_125")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH selection Tightphoton veto","","done_ana/histoZHG_mH125_'${YEAR}'_36.root","zhg_zhsel_photonveto",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZHG_mH125_'${YEAR}'_3738.root","zhg_zll_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZHG_mH125_'${YEAR}'_37.root","zhg_zmm_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZHG_mH125_'${YEAR}'_38.root","zhg_zee_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH cut evolution","","done_ana/histoZHG_mH125_'${YEAR}'_39.root","zhg_zem_cutevol",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"ZH #eta_{j}","","done_ana/histoZHG_mH125_'${YEAR}'_40.root","zhg_zhllsel_etaj",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{miss}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_41.root","zhg_zllhselnminus4_met",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll}-p_{T}^{miss#gamma}|/p_{T}^{ll}","","done_ana/histoZHG_mH125_'${YEAR}'_42.root","zhg_zllhselnminus4_ptfracg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"|p_{T}^{ll#gamma}-p_{T}^{miss}|/p_{T}^{ll#gamma}","","done_ana/histoZHG_mH125_'${YEAR}'_43.root","zhg_zllhselnminus4_ptfrac",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#phi_{ll,p_{T}^{miss#gamma}}","","done_ana/histoZHG_mH125_'${YEAR}'_44.root","zhg_zllhselnminus4_dphidilepmetg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",1,0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#phi_{ll#gamma,p_{T}^{miss}}","","done_ana/histoZHG_mH125_'${YEAR}'_45.root","zhg_zllhselnminus4_dphidilepgmet",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",1,0)';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_46.root","zhg_zllhselnminus4_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"#Delta#phi_{ll,p_{T}^{miss}+E_{T}^{gamma}}","","done_ana/histoZHG_mH125_'${YEAR}'_47.root","zhg_zllhselnminus3_dphidilepmetg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jet,p_{T}^{miss}}","","done_ana/histoZHG_mH125_'${YEAR}'_48.root","zhg_zllhselnminus3_dphijetmet",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_49.root","zhg_zllhselnminus3_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Leading p_{T}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_50.root","zhg_zhgsel_ptl1",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"Signal region",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Trailing p_{T}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_51.root","zhg_zhgsel_ptl2",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"Signal region",0,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"WZ selection m_{T}","GeV","done_ana/histoZHG_mH125_'${YEAR}'_52.root","zhg_wzsel_emulation_mtg",0,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}',0,"WZ region",0,'${APPLYSCALING}')';
  if [ $YEAR != 2019 ]; then
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Bin #","","done_ana/histoZHG_mH125_'${YEAR}'_55.root","zhg_card_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}',"done_ana/fitDiagnosticszhg_comb_125.root","ZHG_'${YEAR}'_125")';
  elif [ $YEAR == 2019 ]; then
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Bin #","","done_ana/histoZHG_mH125_'${YEAR}'_55.root","zhg_card_mt",1,'${YEAR}',"Z(ll)H_{125}(inv.+#gamma) (0.1 #times #sigma_{SM})",'${sf_dy}','${isBlinded}',"",0,'${APPLYSCALING}',"comb/fitDiagnosticszhg_comb_125.root","ZHG_'${YEAR}'_125")';
  fi
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_151617.root","ssww_sswwselnminus1_zstar",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{b jets}","","done_ana/histossww_'${YEAR}'_181920.root","ssww_sswwselnminus1_nbjets",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{#tau}","","done_ana/histossww_'${YEAR}'_212223.root","ssww_sswwselnminus1_ntau",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{leading}","GeV","done_ana/histossww_'${YEAR}'_242526.root","ssww_sswwsel_ptl1",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{trailing}","GeV","done_ana/histossww_'${YEAR}'_272829.root","ssww_sswwsel_ptl2",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_33343536.root","ssww_wzsel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_464748.root","ssww_sswwsel_etaj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_91.root","ssww_zzsel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_92.root","ssww_wzbsel_mjj",0,'${YEAR}',"H_{125}",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","","done_ana/histossww_'${YEAR}'_93.root","ssww_wzsel_bdt",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}Xm_{ll}","","done_ana/histossww_'${YEAR}'_94.root","ssww_datacard",0,'${YEAR}',"H_{125}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}')';
